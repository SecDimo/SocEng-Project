"""
Phishing Awareness Tracking Server
===================================
When someone clicks the link in your phishing email:
1. Their click is logged (name, email, time, IP, browser)
2. They see the "You Failed the Phishing Test" landing page
"""
...
def dashboard():
    ...
    <style>
      ...
      .export a {
        display: inline-block; padding: 10px 20px; background: #003399;
      ...
      <div class="export"><a href="/download-log">Download click_log.csv</a></div>
